...
def Main():
    ...
    argument_parser = argparse.ArgumentParser(
        description=("Extracts information from USN change journal records.")
    )
    ...
    argument_parser.add_argument(
        ...
        metavar="PATH",
        default=None,
        help="path of the USN change journal records.",
    )
    ...
    output_writer.WriteText(
        ",".join(["Date and time", "Name", "File reference", "Parent file reference"])
    )
