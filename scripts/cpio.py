        ...
        while file_offset < stat_object.st_size:
            ...
            if file_type == "cpio":
                ...
                compressed_data_file_object = data_range.DataRange(
                    file_object, data_offset=file_offset, data_size=compressed_data_size
                )
                ...
                if file_type == "bzip":
                    ...
                    cpio_file_object = gzip.GzipFile(
                        fileobj=compressed_data_file_object
...
def Main():
    ...
    if options.hash:
        ...
        output_writer.WriteText(f"\tFormat\t\t: {cpio_archive_file.file_format:s}\n")
