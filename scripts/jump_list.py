...
class StdoutWriter(output_writers.StdoutWriter):
    ...
    def _WriteShortcutLinkInformation(self, lnk_file):
        ...
        self.WriteValue("\t\tShow Window value", f"0x{lnk_file.show_window_value:08x}")
...
def Main():
    ...
    argument_parser = argparse.ArgumentParser(
        description=("Extracts information from Windows Jump List files.")
    )
    ...
    argument_parser.add_argument(
        ...
        metavar="PATH",
        default=None,
        help="path of the Windows Jump List file.",
    )
