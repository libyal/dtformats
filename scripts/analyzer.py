...
class BinaryDataFormatAnalyzer(data_format.BinaryDataFormat):
    ...
    def _DebugPrintDataTypeMap(self, name, data_type_definition, structure_object):
...
def Main():
    ...
    argument_parser = argparse.ArgumentParser(
        description=("Analyzes a data format using a dtFabric definition.")
    )
    ...
    argument_parser.add_argument(
        ...
        metavar="PATH",
        default=None,
        help="path of the dtFabric definition file.",
    )
