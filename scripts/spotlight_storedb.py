...
def GetDateTimeString(timestamp):
    ...
    return "".join(
        [iso8601_string[:10], " ", iso8601_string[11:26], " ", iso8601_string[33:35]]
    )
...
def Main():
    ...
    argument_parser = argparse.ArgumentParser(
        description=("Extracts information from Apple Spotlight store database files.")
    )
    ...
    argument_parser.add_argument(
        ...
        default=None,
        metavar="FSID",
        help="file system identifier (FSID) of the item to show.",
    )
    ...
    argument_parser.add_argument(
        ...
        metavar="PATH",
        default=None,
        help="path of the Apple Spotlight store database file.",
    )
    ...
    if source_lower.endswith(".map.header"):
        ...
        if options.item is None:
            ...
            table_view = TableView(header="Apple Spotlight database information:")
