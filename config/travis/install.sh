...
L2TBINARIES_DEPENDENCIES="PyYAML backports.lzma dtfabric libfwsi liblnk libolecf";

L2TBINARIES_TEST_DEPENDENCIES="funcsigs mock pbr six";

PYTHON2_DEPENDENCIES="libfwsi-python liblnk-python libolecf-python python-backports.lzma python-dtfabric python-yaml";
