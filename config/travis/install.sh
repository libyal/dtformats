...
DPKG_PYTHON3_DEPENDENCIES="libfwsi-python3 liblnk-python3 libolecf-python3 libregf-python3 python3-dfdatetime python3-dtfabric python3-lz4 python3-yaml";
...
RPM_PYTHON3_DEPENDENCIES="libfwsi-python3 liblnk-python3 libolecf-python3 libregf-python3 python3-dfdatetime python3-dtfabric python3-lz4 python3-pyyaml";
