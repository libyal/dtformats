...
L2TBINARIES_DEPENDENCIES="PyYAML backports.lzma dfdatetime dtfabric libfwsi liblnk libolecf python-lz4";

L2TBINARIES_TEST_DEPENDENCIES="funcsigs mock pbr six";

PYTHON2_DEPENDENCIES="libfwsi-python liblnk-python libolecf-python python-backports.lzma python-dfdatetime python-dtfabric python-lz4 python-yaml";

PYTHON2_TEST_DEPENDENCIES="python-coverage python-funcsigs python-mock python-pbr python-six python-tox";

PYTHON3_DEPENDENCIES="libfwsi-python3 liblnk-python3 libolecf-python3 python3-dfdatetime python3-dtfabric python3-lz4 python3-yaml";
