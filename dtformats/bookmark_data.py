...
class MacOSBackgroundItemBookmarkData(data_format.BinaryDataFile):
    ...
    def _ReadIntegersArray(self, file_object, data_area_offset, data_record_offsets):
    ...
    def _ReadStringsArray(self, file_object, data_area_offset, data_record_offsets):
