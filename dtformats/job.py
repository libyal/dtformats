...
class WindowsTaskSchedulerJobFile(data_format.BinaryDataFile):
    ...
    def _FormatSystemTime(self, systemtime):
        ...
        """
        return (
            f"{systemtime.year:04d}-{systemtime.month:02d}-"
    ...
    def ReadFileObject(self, file_object):
        ...
        data_section = self._ReadStructureObjectFromFileObject(
            file_object, 0, "job_fixed_length_data_section", "fixed-length data section"
        )
        ...
        self._task_configuration.application_name = data_section.application_name.string
