...
class WindowsDefenderScanDetectionHistoryFile(data_format.BinaryDataFile):
    ...
    _FABRIC = data_format.BinaryDataFile.ReadDefinitionFile("detection_history.yaml")

    _DEBUG_INFORMATION = data_format.BinaryDataFile.ReadDebugInformationFile(
        "detection_history.debug.yaml",
        custom_format_callbacks={"filetime": "_FormatIntegerAsFiletime"},
    )
