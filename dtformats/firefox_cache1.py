...
class CacheMapFile(data_format.BinaryDataFile):
    ...
    def _ReadFileHeader(self, file_object):
        ...
        if self._debug:
            debug_info = self._DEBUG_INFORMATION.get("firefox_cache1_map_header", None)
    ...
    def _ReadRecord(self, file_object, file_offset):
        ...
        if self._debug:
            debug_info = self._DEBUG_INFORMATION.get("firefox_cache1_map_record", None)
