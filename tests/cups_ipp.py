...
class CupsIppFileTest(test_lib.BaseTestCase):
    ...
    _DATE_TIME_VALUE_DATA = bytes(
        bytearray([0x07, 0xE6, 0x07, 0x07, 0x00, 0x12, 0x1A, 0x00, 0x2B, 0x00, 0x00])
    )
    ...
    def testReadFileObject(self):
        ...
        output_writer = test_lib.TestOutputWriter()
        test_file = cups_ipp.CupsIppFile(debug=True, output_writer=output_writer)
